...
#define SLEEP_TIMEOUT  10000L   // TODO Timeout before sleep

#define LENGTH             40   // Command buffer length

#define RULES_TZ_ADD        0   // Timezone rules EEPROM start address

#define PERIOD          30000   // LED crossfade total duration
#define MAX_ANALOG_V       50   // Analog output max value for RGB
